library(pvclust)
mydata <- read.table("/homes/saketc/research2/saket/BLAST/machine_learning/allchanges_DOM_for_orangemod.tab",sep='\t',header=T)
...
pdf('ec6_all_changes_DOM.pdf',height=6,width=50)
